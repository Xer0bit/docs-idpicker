...
![Prompt editor showing category and subcategory filter, code editor with dynamic variable placeholders highlighted, and Save button](/docs-idpicker/images/user-manual/admin-panel/prompts-editor.png)
...
![Translations manager showing namespace dropdown, locale selector, search bar, and an editable translation key row](/docs-idpicker/images/user-manual/admin-panel/translations-manager.png)
