...
![Assessment builder showing question editor](/docs-idpicker/images/user-manual/admin-panel/assessment-builder.png)
...
![Bulk import preview table showing question rows with type and options columns, and rows flagged with validation errors](/docs-idpicker/images/user-manual/admin-panel/assessment-import-preview.png)
---
