...
![Parent dashboard showing linked children cards with progress percentages and the Link Student form](/docs-idpicker/images/user-manual/parent-panel/dashboard-overview.png)
...
![Student card on parent dashboard with the View Student button highlighted](/docs-idpicker/images/user-manual/parent-panel/student-card.png)
