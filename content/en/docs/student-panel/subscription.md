...
3. Follow the presented flow for plan upgrade.
...
3. Confirm post-upgrade access after completion.

## Common Student Questions

Q: I can read recommendation cards but cannot download full report.
A: Full report export can be plan/availability controlled.

Q: I see subscription in sidebar but route fails.
A: Use in-module upgrade actions until dedicated route is enabled in your deployment.
