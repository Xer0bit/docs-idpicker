...
![Enrollment requests list showing pending student cards with profile preview, and Approve and Deny buttons](/docs-idpicker/images/user-manual/advisor-panel/enrollment-requests.png)
...
![Family chat interface showing student thread, parent thread, and family thread tabs with message composer at bottom](/docs-idpicker/images/user-manual/advisor-panel/family-chat.png)
